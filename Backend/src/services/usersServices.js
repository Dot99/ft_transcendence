...
import { isUserActive } from "../routes/wsRoutes.js";
        ...
        db.serialize(() => {
            ...
            db.run(
                ...
                (err) => {
                    if (err) {
                        console.error(
                            "DB error cleaning up user matchmaking:",
                            err
                        );
                        db.run("ROLLBACK");
                        return reject(err);
