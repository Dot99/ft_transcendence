...
<div class="fixed inset-0 min-h-screen min-w-screen bg-[url(./images/background.png)] bg-cover bg-center text-white">
  ...
  <button
    id="backToMenuBtn"
    class="absolute top-8 left-8 flex items-center gap-2 px-5 py-3 rounded border-2 border-[#4CF190] text-[#4CF190] bg-[#001B26] hover:bg-[#4CF190] hover:text-[#001B26] transition-all font-bold z-20"
  >
